...
public class TwitterStream {
    ...
    /*
     * Constructor that takes in rules
     * */
    public TwitterStream(Map<String, String> rules) throws IOException, URISyntaxException {
        String bearerToken = System.getenv("TWITTER_BEARER_TOKEN");
        if (null != bearerToken) {
            setupRules(bearerToken, rules);
        } else {
            System.out.println("BEARER TOKEN ERROR");
        }
    }
     ...
     * */
    public HttpEntity connectStream(String bearerToken) throws IOException, URISyntaxException {
